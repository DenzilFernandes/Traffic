short int Lane1[] = {13,12,11}; // Lane 1 Red, Yellow and Green
short int Lane2[] = {10,9,8};// Lane 2 Red, Yellow and Green
short int Lane3[] = {7,6,5};// Lane 3 Red, Yellow and Green
short int Lane4[] = {4,3,2};// Lane 4 Red, Yellow and Green
